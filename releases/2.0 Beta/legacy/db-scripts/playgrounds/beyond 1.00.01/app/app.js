...
checkUserAuthentication().then((user) => {
    if (user) {
       ...
       const emailRef = ref(database, 'users/' + userId + '/email');
            ...
            if (newObj && newObj !== "") {
                ...
                if (type == "signature") {
                    ...
                    roomOccCollection.find((object) => {
                        ...
                        const isOverlapping = (
                            (timeFromInputVal >= objectTimeFrom || timeFromInputVal <= objectTimeTo) ||
                            (timeToInputVal >= objectTimeFrom || timeToInputVal <= objectTimeTo) ||
                    ...
                    if (overlapBool == true) {
                        alert("im ausgewählten Zeitraum ist der Raum bereits besetzt")
                    } else {
       ...
       dataExpand.addEventListener('click', () => {
        ...
        onValue(emailRef, function (snapshot){
        ...
        addRoomOccForm.addEventListener('submit', () => {
